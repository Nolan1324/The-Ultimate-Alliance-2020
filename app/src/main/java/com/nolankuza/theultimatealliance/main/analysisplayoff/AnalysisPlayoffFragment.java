...
public class AnalysisPlayoffFragment extends Fragment {

    public AnalysisPlayoffFragment() {

    }

    public static AnalysisPlayoffFragment newInstance() {
        AnalysisPlayoffFragment fragment = new AnalysisPlayoffFragment();
        return fragment;
    }
    ...
    private void generate(View view, PlayoffData[] playoffDataArray) {
        ((AnalysisPlayoffView) view.findViewById(R.id.red_analysis)).generate(Alliance.Red,
                playoffDataArray[0],
                playoffDataArray[1],
                playoffDataArray[2]);
        ((AnalysisPlayoffView) view.findViewById(R.id.blue_analysis)).generate(Alliance.Blue,
                playoffDataArray[3],
                playoffDataArray[4],
                playoffDataArray[5]);
    }
